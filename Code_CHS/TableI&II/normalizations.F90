...
subroutine normalize_parameters
   ...
   !Imposing normalizations
    ...
    Z(t,63,6) = 1.0d0   !Normalize log faminc A
    ...
    do s = 1, nstage
        ...
        G(s,1,6) = 0.0d0						!Initial "technology"
        ...
        G(s,2,6) = 0.0d0						!Initial "technology"
        G(s,3,3) = 0.8d0						!Initial "technology"
        G(s,6,6) = 0.9d0						!Initial "technology"
    end do									
    ...
    G(1,1,:) = (/0.6d0, 0.1d0, 0.1d0, 0.1d0, 0.1d0, 0.0d0/)	
    phi(1,1) = 0.1d0
    Q(1,1,1) = 0.1d0    

    G(2,1,:) = (/0.6d0, 0.1d0, 0.1d0, 0.1d0, 0.1d0, 0.0d0/)	
    phi(2,1) =-0.1d0
    Q(2,1,1) = 0.1d0    

    G(1,2,:) = (/0.1d0, 0.6d0, 0.1d0, 0.1d0, 0.1d0, 0.0d0/)
    phi(1,2) =-0.1d0
    Q(1,2,2) = 0.1d0
   
    G(2,2,:) = (/0.1d0, 0.6d0, 0.1d0, 0.1d0, 0.1d0, 0.0d0/)
    phi(2,2) =-0.1d0
    Q(2,2,2) = 0.1d0
