...
subroutine normalize_parameters
   ...
   !Imposing normalizations
    ...
    t = ntime
    alpha(1,1) =  0.96675812d0
    alpha(1,2) =  0.45938466d0
    alpha(2,1) = -0.13815759d0
    alpha(2,2) = -0.43331089d0
    alpha(3,1) = -0.02594748d0
    alpha(3,2) = -0.28453554d0
    alpha(4,1) = -0.13042675d0
    alpha(4,2) = -0.26242532d0
    ...
    do s = 1, nstage
        G(s,1,:)   = (/0.69381393d0, 0.00719991d0, 0.24029071d0, 0.04054971d0, 0.01814574d0/)           
        G(s,2,:)   = (/0.00000001d0, 0.77217662d0, 0.16207349d0, 0.00000005d0, 0.06574984d0/)          
        Const(s,3) =  0.59277951d0
        G(s,3,3) = 0.90608439d0						
    end do									
    
    do s = 1, nstage
        phi(s,1) = -0.95500590d0
        phi(s,2) = -0.70193531d0
        rho(s,1) =  1.0d0
        rho(s,2) =  1.0d0
    end do
