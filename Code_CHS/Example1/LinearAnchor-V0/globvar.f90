...
integer, parameter :: nind	  = 2000  	    !Number of Individuals
integer, parameter :: ntime	  =    8        !Number of Time Periods
integer, parameter :: nfac	  =    2        !Number of dynamic factors
integer, parameter :: nmea    =    6        !Number of measurements
integer, parameter :: nx	  =    2	    !Number of Observables in dynamic measurements
integer, parameter :: nstage  =    1        !Number of stages in developmental process
...
integer, parameter :: iP0     =    0        !Indicator of P Inverse
